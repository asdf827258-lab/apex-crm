...
/* ⚠ 2026-09-25 기준선. <b>줄이라고만 있는 수</b>입니다.
     ...
     서랍   0  — ★ 2026-09-26 에 <b>밝혔습니다</b>(var(--t-card)).
                 다시 어두워지면 여기서 바로 빨간불입니다.
                 그때 check-nav 의 대비 자도 같이 되돌려야 합니다 — 그 자는
                 이제 <b>밝은 서랍</b>을 전제로 잽니다(왼쪽 색 띠로 한 줄기를
                 재고, 칸은 테두리로 구분된 것도 봅니다).                  */
const BASE = { 안입음: 93, 서랍: 0 };
